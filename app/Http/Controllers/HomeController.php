...
class HomeController extends Controller
{
    ...
    public function add_booking(Request $request, $id)
    {
        ...
        if ($isBooked)
            ...
            $data->save();
            return redirect()->route('facture', ['name' => $data->name]);
        }
    }
    ...
    public function facture(Request $request)
    {
        ...
        $name = $request->name;
        // Récupérer les réservations de l'utilisateur connecté basées sur son name
        $bookings = Booking::where('name', $name)->get();
        $data = Booking::where('name', $name)->first();
